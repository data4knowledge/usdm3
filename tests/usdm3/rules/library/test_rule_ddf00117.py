...
def test_initialization(rule):
    ...
    assert rule._rule_text == "A study protocol document version's protocol status must be specified using the Protocol Status Value Set Terminology (C188723) DDF codelist."
