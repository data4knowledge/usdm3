...
def test_initialization(rule):
    ...
    assert rule._rule_text == "Every study version must have exactly one study identifier with an identifier scope that references a clinical study sponsor organization."
