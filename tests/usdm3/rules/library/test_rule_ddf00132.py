...
def test_initialization(rule):
    ...
    assert rule._rule_text == "Within a study design, if a planned completion number is defined, it must be specified either in the study population or in all cohorts."
