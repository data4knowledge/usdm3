...
def test_initialization(rule):
    ...
    assert rule._rule_text == "A timing's relative to/from property must be specified using the Timing Relative To From Value Set Terminology (C201265) SDTM codelist."
