...
def test_klass_and_attribute_exception(tmp_path, temp_file):
    ...
    assert (
        "failed to find codelist for class 'NonExistentClass' attribute 'nonExistentAttribute'"
    ...
    assert (
        "failed to find codelist for class 'TestClass' attribute 'nonExistentAttribute'"
        in str(excinfo.value)
    )
