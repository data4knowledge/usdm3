...
def test_create():
    ...
    globals.clear()
    api_instance = APIInstance(globals)
    code = api_instance.create(Code, {'id': 'XXX', 'code': 'CODE-1', 'codeSystem': 'CDISC', 'codeSystemVersion': '1.0.0', 'decode': 'Decode-1'})
...
def test_create_no_id():
    ...
    globals.clear()
    api_instance = APIInstance(globals)
    code = api_instance.create(Code, {'code': 'CODE-1', 'codeSystem': 'CDISC', 'codeSystemVersion': '1.0.0', 'decode': 'Decode-1'})
    assert code.model_dump() == {
        'code': 'CODE-1',
        'codeSystem': 'CDISC',
        'codeSystemVersion': '1.0.0',
