...
class TestLibraryAPIAdditional:
    ...
    def test_get_package_generic_not_in_package_items(self, mock_get):
        ...
        mock_response.json.return_value = {
            "_links": {
                "biomedicalConcepts": [{"title": "New BC", "href": "/generic/new_bc"}]
            }
        }
    ...
    def test_sdtm_bc_property_as_usdm_dec_no_match_with_assigned_term_missing_fields(
        self,
    ):
