...
class TestLibraryAPI:
    ...
    def test_biomedical_concept_property_object(self):
        ...
        result = self.api._biomedical_concept_property_object(
            name, label, datatype, responses, code
        )
    ...
    def test_biomedical_concept_object(self):
        ...
        result = self.api._biomedical_concept_object(
            name, label, synonyms, reference, code
        )
    ...
    def test_get_dec_match_not_found(self):
        ...
        data = {"dataElementConcepts": [{"conceptId": "C12345", "name": "Concept1"}]}
    ...
    def test_get_from_url_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            f"{LibraryAPI.API_ROOT}/test/url", headers=self.api._headers
        )
    ...
    def test_get_package_metadata_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            "_links": {"packages": [{"href": "/package1"}, {"href": "/package2"}]}
        }
        mock_get.return_value = mock_response
    ...
    def test_get_package_success(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.json.return_value = {
            "_links": {"biomedicalConcepts": [{"title": "Test BC", "href": "/bc/test"}]}
        }
        mock_get.return_value = mock_response
    ...
    def test_get_from_url_all_success(self, mock_get):
        ...
        sdtm_response = {
            "shortName": "TEST_BC",
            "_links": {"parentBiomedicalConcept": {"href": "/generic/test"}},
        }
    ...
    def test_refresh_method(self, mock_get):
        ...
        package_response.json.return_value = {"_links": {"packages": []}}
        ...
        with (
            patch.object(self.api, "_get_sdtm_bcs") as mock_sdtm,
    ...
    def test_sdtm_bc_property_as_usdm_with_dec_id(self):
        ...
        generic = {
            "dataElementConcepts": [
                {"conceptId": "C12345", "shortName": "Test Concept"}
            ]
        }
    ...
    def test_get_package_items_method(self, mock_get):
        ...
        mock_response.json.return_value = {
            "_links": {
                ...
                "biomedicalConcepts": [
                    {"title": "Test Generic BC", "href": "/generic/bc1"}
                ],
            }
        }
        mock_get.return_value = mock_response
    ...
    def test_get_sdtm_bcs_method(self, mock_get):
        ...
        self.api._package_items = {"sdtm": {"TEST BC": {"href": "/sdtm/test"}}}
    ...
    def test_sdtm_bc_property_as_usdm_no_dec_match(self):
        ...
        generic = {
            "dataElementConcepts": [
                {"conceptId": "C12345", "shortName": "Different Concept"}
            ]
        }
    ...
    def test_sdtm_bc_property_as_usdm_no_dec_id_no_assigned_term(self):
        ...
        sdtm_property = {"name": "TESTVAL", "dataType": "text"}
        generic = {}
    ...
    def test_sdtm_bc_property_as_usdm_value_list_no_codelist(self):
        ...
        sdtm_property = {"name": "TESTVAL", "dataType": "text", "valueList": ["VALUE1"]}
        generic = {}
    ...
    def test_get_package_generic_duplicate_key(self, mock_get):
        ...
        mock_response.json.return_value = {
            "_links": {
                "biomedicalConcepts": [{"title": "Test BC", "href": "/generic/bc1"}]
            }
        }
        mock_get.return_value = mock_response
    ...
    def test_get_sdtm_bcs_map_missing_reference(self, mock_get):
        ...
        assert (
            self.api.errors.error_count() >= 0
        )  # Info messages don't increase error count
